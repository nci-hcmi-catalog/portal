...
export const clinicalTumorDiagnosisDependent = {
  'histological type': {
    ...
    'ampulla of vater': [
      'Will need to develop several CDEs for this so there can be subquestions for the major histological subtypes:',
      '3081934 is the primary question: Histological subtype',
      'Adenocarcinoma',
      ...
      '6326080: If adenocarcinoma, select the histotype:',
      'Intestinal',
      'Mixed',
      'Pacreatico-biliary',
      '6326081: If adenocarcinoma with peculiar aspects, select the subtype:',
      'Clear cell',
      'Mucinous',
      'Signet ring',
      'Squamous differentiation',
      '6326082: If well-differentiated or moderately-differentiated neuroendocrine tumor, specify the hormones released:',
      'Non-enumerated',
    ],
  },
  ...
  'tumor histological grade': {
    ...
    'thyroid cancer': [],
    'wilms tumor': [],
    'ampulla of vater': ['WHO Grade (2785839) for AVC does not include G4 or GB'],
  },
};
