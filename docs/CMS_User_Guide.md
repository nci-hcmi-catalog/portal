...
5. Click the "Save" button in the top right corner when you have completed filling in the form fields. The model will be saved to the database, but not available on the public searchable catalog.
