...
## [Model Management](#model-management)
### Bulk Upload
Content Administrators can upload multiple models at a time using a Google sheet. 
...
To use this template, click File > Make a Copy.  From the copy, you can add model data.  For fields that do not have validation rules in the sheet, please refer to [data dictionary](#data-dictionary) for individual field rules. 
